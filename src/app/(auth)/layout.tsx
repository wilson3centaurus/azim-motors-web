...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto grid min-h-[calc(100vh-3rem)] max-w-6xl overflow-hidden rounded-[32px] border border-white/60 bg-white/60 shadow-[0_40px_120px_-48px_rgba(21,38,36,0.65)] backdrop-blur-sm lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="flex min-h-full flex-col justify-between p-5 sm:p-8 lg:p-10">
          <div className="mb-8 flex items-center justify-between lg:hidden">
            <div>
              <p className="font-display text-xl font-bold text-slate-900">Azim Motors</p>
              <p className="text-sm text-slate-500">Mobile-first garage operations</p>
            </div>
          </div>
